    ...
    if ga == '1':
        ...
        if changelog_source[0] == '1' and 'Drupal' in changelog_source[1]:
            ...
            for line in cl_array:
                ...
                if match != []:
                    cmseek.success(f'Drupal version {cmseek.bold}{match[0]}{cmseek.cln} detected')
                    return match[0]
