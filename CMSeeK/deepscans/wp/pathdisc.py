...
def start(url,ua):
    ...
    rss_file = f'{url}/wp-includes/rss.php'
    ...
    tw_theme = f'{url}/wp-content/themes/twentyfifteen/index.php'
    ...
    tw_theme = f'{url}/wp-content/themes/twentysixteen/index.php'
    theme_source = cmseek.getsource(tw_theme, ua)
    if theme_source[0] == '1' and 'Uncaught Error:' in theme_source[1]:
        path = re.findall(r'<b>(.*?)wp-content/themes/twentyfifteen/index.php</b>', theme_source[1])
        if path != []:
    ...
    tw_theme = f'{url}/wp-content/themes/twentyseventeen/index.php'
    theme_source = cmseek.getsource(tw_theme, ua)
    if theme_source[0] == '1' and 'Uncaught Error:' in theme_source[1]:
        path = re.findall(r'<b>(.*?)wp-content/themes/twentyfifteen/index.php</b>', theme_source[1])
        if path != []:
